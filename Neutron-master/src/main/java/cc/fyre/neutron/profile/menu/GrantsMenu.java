...
public class GrantsMenu extends PaginatedMenu {
        ...
        for (Grant grant : this.profile.getGrants().stream().sorted(new GrantWeightComparator().reversed().thenComparing(new GrantDateComparator().reversed())).collect(Collectors.toList())) {
            ...
            toReturn.put(toReturn.size(), new Button() {
                ...
                public List<String> getDescription(Player player) {
                    ...
                    toReturn.add(ChatColor.YELLOW + "By: " + ChatColor.RED + Proton.getInstance().getUuidCache().name(grant.getExecutor()));
    ...
    public class RemovePrompt extends StringPrompt {
        ...
        public Prompt acceptInput(ConversationContext conversationContext, String input) {
            ...
            this.menu.openMenu(sender);
            conversationContext.getForWhom().sendRawMessage(ChatColor.GREEN + "Removed " + this.grant.getRank().getFancyName() + ChatColor.GOLD + " grant from " + this.profile.getFancyName() + ChatColor.GOLD + ".");
