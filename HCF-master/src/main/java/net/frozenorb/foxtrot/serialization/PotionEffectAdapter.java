...
public class PotionEffectAdapter implements JsonDeserializer<PotionEffect>, JsonSerializer<PotionEffect> {
    public JsonElement serialize(final PotionEffect src, Type typeOfSrc, JsonSerializationContext context) {
        return toJson(src);
    }

    public PotionEffect deserialize(final JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
