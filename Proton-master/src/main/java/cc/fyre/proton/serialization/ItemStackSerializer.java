package cc.fyre.proton.serialization;
...
public final class ItemStackSerializer {
    ...
    public static BasicDBObject serialize(ItemStack itemStack) {
        ...
        if (itemStack.hasItemMeta()) {
            ...
            if (m.getLore() != null) {
                //BasicDBList dblist = Proton.get().getDatabaseRepresentation(m.getLore());
    ...
    public static ItemStack deserialize(BasicDBObject dbObject) {
        ...
        if (dbObject.containsField("meta")) {
            ...
            if (meta.containsField("lore")) {
                //nal HashSet<String> lore = Proton.get().getSetRepresentation((BasicDBList) meta.get("lore"));
