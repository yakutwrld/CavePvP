package org.cavepvp.profiles.menu.page;
...
public abstract class ProfilePaginatedMenu extends Menu {
    ...
    public final Map<Integer, Button> getButtons(Player player) {
        ...
        buttons.put(18, new org.cavepvp.profiles.menu.page.PageButton(-1, this));
        buttons.put(26, new org.cavepvp.profiles.menu.page.PageButton(1, this));
        ...
        for (Map.Entry<Integer, Button> entry : getAllPagesButtons(player).entrySet()) {
            ...
            if (ind >= minIndex && ind < maxIndex) {
                ...
                buttons.put(18+ind, entry.getValue());
            }
