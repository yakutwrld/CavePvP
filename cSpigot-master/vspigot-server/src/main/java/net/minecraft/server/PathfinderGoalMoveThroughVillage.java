        ...
        if (this.e && this.a.world.w()) {
            ...
            if (village == null) {
                ...
                if (this.d == null) {
                    ...
                    this.c = this.a.getNavigation().a(net.valorhcf.pathsearch.PositionPathSearchType.MOVETHROUGHVILLAGE, (double) this.d.locX, (double) this.d.locY, (double) this.d.locZ); // Poweruser
                    ...
                    if (this.c != null) {
                        ...
                        if (vec3d == null) {
                            ...
                            this.a.getNavigation().b(false);
                            this.c = this.a.getNavigation().a(net.valorhcf.pathsearch.PositionPathSearchType.MOVETHROUGHVILLAGE, vec3d.a, vec3d.b, vec3d.c); // Poweruser
                            this.a.getNavigation().b(flag);
                            return this.c != null;
                        }
                    }
