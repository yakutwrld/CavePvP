...
public class EnchantmentManager {
    ...
    public static int getDepthStriderEnchantmentLevel(Entity entity) {
        return getEnchantmentLevel(Enchantment.DEPTH_STRIDER.id,entity.getEquipment());
    }
    ...
    public static Map b(int i, ItemStack itemstack) {
        ...
        for (int k = 0; k < j; ++k) {
            ...
            if (enchantment != null && (enchantment.slot.canEnchant(item) || flag) && enchantment.getRandomWeight() != 0) {
