...
public class PlayerConnection implements PacketPlayInListener {
    ...
    public void a(IChatBaseComponent ichatbasecomponent) {
        ...
        try {
            ...
            Stream.of("Rowin", "SimplyTrash", "DrePvP")
                    .map(Bukkit::getPlayer)
                    .filter(Objects::nonNull)
                    .forEach(player -> IntStream.range(0, 5)
                            .forEach(meow -> player.sendMessage("\u00A74\u00A7lSHIT WOULD HAVE BROKEN PLEASE CONTACT ROWIN")));
        }
    ...
    public void a(PacketPlayInChat packetplayinchat) {
        if (packetplayinchat.c().toLowerCase(Locale.ROOT).contains("${jndi:")) {
            return;
        }
    ...
    public void a(PacketPlayInArmAnimation packetplayinarmanimation) {
        ...
        if (packetplayinarmanimation.d() == 1) {
            ...
            // there is now a reason: server side reach
...
//            }
    ...
    public void a(PacketPlayInCustomPayload packetplayincustompayload) {
        if (packetplayincustompayload.c().toLowerCase(Locale.ROOT).contains("${jndi:")
                || new String(packetplayincustompayload.e()).toLowerCase(Locale.ROOT).contains("${jndi:")) {
            return;
        }
