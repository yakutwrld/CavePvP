...
public abstract class EntityHuman extends EntityLiving implements ICommandListener {
    ...
    private static final Timer cpsTimer = new Timer("CPS Remover", true);
            ...
            if (f > 0.0f || f2 > 0.0f) {
                ...
                if (flag3) {
                    ...
                    if (i > 0) {
                        ...
                        final Knockback knockbackProfile = getKnockback() == null ? SpigotConfig.defaultKnockback : getKnockback();

                        entity.g(
                                (-MathHelper.sin(this.yaw * 3.1415927F / 180.0F) * (float) i * knockbackProfile.getExtraHorizontal()),
                                knockbackProfile.getExtraVertical(),
                                (MathHelper.cos(this.yaw * 3.1415927F / 180.0F) * (float) i * knockbackProfile.getExtraHorizontal())
                        );
