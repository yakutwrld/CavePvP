...
public class EntityDamageSourceIndirect extends EntityDamageSource {
    ...
    public IChatBaseComponent getLocalizedDeathMessage(EntityLiving entityliving) {
        ...
        return itemstack != null && itemstack.hasName() && LocaleI18n.c(s1) ? new ChatMessage(s1,entityliving.getScoreboardDisplayName(),ichatbasecomponent,itemstack.E()) : new ChatMessage(s,entityliving.getScoreboardDisplayName(),ichatbasecomponent);
    }
