...
public abstract class World implements IBlockAccess {
    ...
    public List getCubes(Entity entity, AxisAlignedBB axisalignedbb) {
        return this.getCubes(entity,axisalignedbb,EMPTY_SET);
    }

    public List getCubes(Entity entity, AxisAlignedBB axisalignedbb,Set<Block> prohibit) {
        this.L.clear();
                ...
                for ( int x = xstart; x < xend; x++ )
                {
                    for ( int z = zstart; z < zend; z++ )
                    {
                        for ( int y = ystart; y < l; y++ )
                        {
                            ...
                            if ( block != null && block != Blocks.AIR && (prohibit == null || !prohibit.contains(block))) // MineHQ
                            {
    ...
    private final Set<Block> EMPTY_SET = new HashSet<>();
}
