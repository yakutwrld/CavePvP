...
public class PathfinderGoalMoveIndoors extends PathfinderGoal {
    ...
    public void c() {
        ...
        if (this.a.e((double) this.b.getIndoorsX(), (double) this.b.locY, (double) this.b.getIndoorsZ()) > 256.0D) {
            ...
            if (vec3d != null) {
                this.a.getNavigation().a(net.valorhcf.pathsearch.PositionPathSearchType.MOVEINDOORS, vec3d.a, vec3d.b, vec3d.c, 1.0D); // Poweruser
            }
        } else {
            this.a.getNavigation().a(net.valorhcf.pathsearch.PositionPathSearchType.MOVEINDOORS, (double) this.b.getIndoorsX() + 0.5D, (double) this.b.getIndoorsY(), (double) this.b.getIndoorsZ() + 0.5D, 1.0D); // Poweruser
        }
    }
