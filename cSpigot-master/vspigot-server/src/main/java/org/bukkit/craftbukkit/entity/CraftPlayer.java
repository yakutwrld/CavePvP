...
public class CraftPlayer extends CraftHumanEntity implements Player {
    ...
    public void disguise(String name, String texture,String textureSignature) {
        ...
        if (texture != null) {
            disguisedProfile.getProperties().put("texture", new net.minecraft.util.com.mojang.authlib.properties.Property("textures", texture, textureSignature));
        }
